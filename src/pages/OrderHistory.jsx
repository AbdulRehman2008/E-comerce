    ...
    return (
      <div className="min-h-screen bg-gray-50 pt-24">
        <div className="max-w-3xl mx-auto px-4 py-8 text-center">
          <h1 className="text-2xl font-light text-gray-900 mb-4">Order History</h1>
          <p className="text-gray-600 mb-6">Please log in to view your orders.</p>
          <Link to="/login" className="inline-block bg-gray-900 text-white px-6 py-3 rounded-lg hover:bg-gray-800">Login</Link>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24">
      <div className="max-w-5xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-light tracking-wide text-gray-900 mb-6">Your Orders</h1>
