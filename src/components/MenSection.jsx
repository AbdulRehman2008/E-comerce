  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Take only the first 4 men's clothing items
        ...
        if (selectedProducts.length === 0) {
          throw new Error('No men\'s clothing products found');
        }
    ...
    <section className="py-16 md:py-24 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-light mb-4 text-gray-900">Men's Collection</h2>
          <p className="text-gray-600 text-sm md:text-base font-light max-w-2xl mx-auto">
            Explore our latest collection of men's fashion essentials.
          </p>
        </div>
